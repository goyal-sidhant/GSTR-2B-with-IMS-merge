...
class LogPanel(QWidget):
    ...
    def _append_log_message(self, timestamp: str, level: str, message: str):
        ...
        if level == "ERROR":
            ...
            fmt.setForeground(QColor("#fd7e14"))  # Orange
        elif level == "INFO":
            if "✓" in message or "Merged" in message or "Created" in message:
                fmt.setForeground(QColor("#198754"))  # Green for success
            elif "✗" in message or "Failed" in message:
                fmt.setForeground(QColor("#dc3545"))  # Red for failure
            else:
                fmt.setForeground(QColor("#212529"))  # Default dark
        elif level == "DEBUG":
    ...
    def set_complete(self):
        ...
        self.status_label.setStyleSheet(
            "font-weight: bold; font-size: 11pt; color: #198754;"
        )
